...
- **初回訴求**: 初回14日間、Plusと同じ機能（Magic Link は短文、Confirm signup / Invite は機能一覧付き）
- **免責**: 医療診断ではない旨を全テンプレートのフッター付近に記載
...
メールヘッダーのロゴは `{{ .SiteURL }}/logo.png`（512×512）を参照します。**デプロイ後**にテンプレートを反映してください。

---

## 更新履歴

- 2026-05: UI 文言に合わせてコピー統一（Plusと同じ機能、あなた（保護者）、毎週月曜の振り返りレポート、免責の全テンプレート化）
- 2026-05: 認証メールヘッダーをロゴ画像（`/logo.png`）に統一
- 2026-05: となりっこブランド、Free/Plus、14 日体験期間、OTP ログインに合わせて全面刷新
